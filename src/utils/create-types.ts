...
const createTypeRecursive = async (remaining: Array<string>) => {
  ...
  console.log(
    colors.green.underline(
      `api-chunk adding new "${type}" imports and routes to index.js`
    )
  );
  try {
  ...
  console.log(
    colors.green.underline(
      `api-chunk adding new controllers to controllers/${type}.js`
    )
  );
  try {
  ...
  console.log(
    colors.green.underline(
      `api-chunk adding new model to models/${type}.js and models/index.js`
    )
  );
